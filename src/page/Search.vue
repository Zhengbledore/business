              ...
              <div class="box-item">
                ...
                <div class="box-product-info-box">
                  ...
                  <div class="product-price-m">
                    <em>¥<span class="big-price cye-lm-tag">1979</span><span class="small-price cye-lm-tag">.00</span></em>
                  </div>
  ...
  export default{
    data(){
      ...
      return {
        ...
        flatButtons: [
          {label: '时间', value: 'time', color: '#f15353', sort: 'default', icon: 'import_export'},
          {label: '成交', value: 'complete', color: '', sort: 'default', icon: 'import_export'},
          {label: '价格', value: 'price', color: '', sort: 'default', icon: 'import_export'},
          {label: '好评', value: 'good', color: '', sort: 'default', icon: 'import_export'},
        ],
        water
      }
    },
...
//        item.icon = 'arrow_drop_down'
        ...
        if (this.flatButtons.indexOf(item) > -1) {
          ...
          /* make a new search request with sort */

          /* step 1: use store.dispatch, params is query and sort */
//          this.$store.dispatch('goToSearch', {
//            type: 'show',
//            data: searchTextFieldValue,
//            sort: []
//          })

          /* step 2: in request and response time, open loading */

          /* step 3: get correct data to this.list, and close loading */
        } else {
          return
        }
      }
